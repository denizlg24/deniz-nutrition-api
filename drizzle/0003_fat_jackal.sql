...
FOR EACH ROW
EXECUTE FUNCTION "items_update_search_vectors"();--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "items_search_vector_english_idx" ON "items" USING gin ("search_vector_english");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "items_search_vector_portuguese_idx" ON "items" USING gin ("search_vector_portuguese");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "items_search_vector_spanish_idx" ON "items" USING gin ("search_vector_spanish");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "items_search_vector_french_idx" ON "items" USING gin ("search_vector_french");--> statement-breakpoint
